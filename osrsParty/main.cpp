...
int main(int argc, char const *argv[]) {
  int numMessages = 50; //numer of messages to be sent
  std::string message_arr[11];   //defining possible outputs
  int message_arr_size=11;
...
void loopMsgList(std::string message_arr[], int message_arr_size, int numMessages){
  ...
  std::mt19937 eng2(rd2());
   ...
   //900,1080 -> 15-18 mins
  std::uniform_int_distribution<> distr(5,15);
